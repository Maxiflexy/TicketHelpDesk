            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #ddd;">
                ...
                <tr>
                    <td align="center" style="background-color: #0191f1; padding: 30px 20px;">
                        <img src="https://res.cloudinary.com/drk3cmq8j/image/upload/v1732700894/2_r93yck.png" alt="Infometics Limited" width="150"
                        height="auto"  style="margin-bottom: 20px;">
                ...
                <tr>
                    <td style="padding: 40px 30px; font-size: 16px; color: #333333;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #e6f3ff; border-left: 4px solid #0191f1; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
                            <tr>
                                <td>
                                    <p style="margin: 0; font-weight: normal;">Your password on your account:</p>
                                    <p style="margin: 0; font-weight: bold; color: #0191f1;">${email}</p>
                                    <p style="margin: 0;">has been reset.</p>
                                    <p style="margin: 10px 0;">New Password: <span style="font-weight: bold; color: #0191f1;">${password}</span></p>
                                    <p style="margin: 10px 0;">Kindly ignore this message if you did not initiate this request.</p>
                                </td>
                            </tr>
                        </table>
