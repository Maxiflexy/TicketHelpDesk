            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #ddd;">
                ...
                <tr>
                    <td align="center" style="background-color: #0191f1; padding: 30px 20px;">
                        ...
                        <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #ffffff;">Password Reset Notification</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 40px 30px; font-size: 16px; color: #333333;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #e6f3ff; border-left: 4px solid #0191f1; padding: 15px; margin-bottom: 20px;">
                            <tr>
                                <td>
                                    <p style="margin: 0;">A password reset has been initiated on your account:</p>
                                    <p style="margin: 0; font-weight: bold; color: #0191f1;">${email}</p>
                                    <p style="margin: 10px 0;">See below token for authentication:</p>
                                    <p style="margin: 10px 0;">Token: <span style="font-weight: bold; color: #0191f1;">${OTP}</span></p>
                                    <p style="margin: 10px 0;">Kindly ignore if you have not initiated this request.</p>
                                </td>
                            </tr>
                        </table>
